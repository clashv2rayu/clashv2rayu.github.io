...
for page_idx in range(total_pages):
    ...
    for dt, bname in page_posts:
        ...
        card_html = f'''                            <div class="row content item xcblog-blog-item" data-date="{y_str}-{mo_str}-{d_str}">
                                <div class="col-md-3">
                                    <a href="/clashnode/free-nodes/{bname}" class="xcblog-blog-url">
                                        <img src="/clashnode//uploads/20241122/c6a42b2aa92a2d63eaf82188b338cc1d.webp" alt="{card_date_display}→{current_random_speed}|{y_str}年最新免费节点clashnode订阅链接地址" style="width:100%;">
                                    </a>
                                </div>
                                <div class="col-md-9">
                                    <a href="/clashnode/free-nodes/{bname}" class="xcblog-blog-url">
